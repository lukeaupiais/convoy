...
export const runtimeCommandContracts = {
  ...
  deleteTicketConnection: contract(['id', 'revision']),
  probeTicketConnection: contract(['id']),
  previewExternalTickets: contract(['connectionId', 'projectId'], ['limit']),
  publishTicket: contract(['requestId', 'ticketId', 'revision', 'connectionId']),
  ...
  saveBoardTemplate: contract(
    ['name', 'columns'],
    ['id', 'description', 'revision', 'swimlanes', 'filters', 'cardFields', 'grouping', 'creationPolicy', 'destinationConnectionIds', 'density'],
  ),
